...
Detail see [[https://github.com/openshift/source-to-image/tree/release-3.11][source-to-image]].
...
#+begin_example
  ...
  fatal: ... Peer's certificate issuer has been marked as not trusted by the user.
